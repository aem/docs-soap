...
import { convertGoogleToHTML } from '../src/index';
...
describe('Google Docs Converter', () => {
  ...
  it('converts inline styles from google docs properly', () => {
    ...
    const doc = parseHTML(convertGoogleToHTML(documents.inlineStyles));
  ...
  it('converts links from google docs properly', () => {
    ...
    const doc = parseHTML(convertGoogleToHTML(documents.links));
